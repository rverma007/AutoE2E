...
class TestLetterTypeDetailVerify:
    # TC_LT_DET_001 removed — covered by test_download_letter.test_download_ang / test_download_bu
    # TC_LT_DET_004 removed — search row verification covered by test_download_letter
